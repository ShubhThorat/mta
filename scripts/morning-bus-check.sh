...
# Only fires if there's a Home calendar event starting in the next 90 minutes.
...
# Check calendar: any Home event starting in the next 30–90 min?
HAS_EVENT=$(osascript <<'ASEOF'
